	...
	<div class="absolute w-screen flex justify-center items-center p-5 z-20">
		...
		>
			...
			<ul class="dark:text-white text-black">
				...
				<li class="inline mx-5 transition ease-in-out delay-200">Projects</li>
			</ul>
			<ul class="dark:text-white flex gap-5 justify-end items-center">
				<a href="/"
					><svg
						xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 496 512"
						class="dark:fill-white fill-black w-[30px] transition ease-in-out delay-200"
